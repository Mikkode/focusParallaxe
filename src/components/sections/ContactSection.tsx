    ...
    <div ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
      <div className="text-center mb-12 animate-on-scroll opacity-0 transition-all duration-700 delay-100">
        ...
        <p className="text-slate-300 max-w-2xl mx-auto">
          Des questions ? Notre équipe est là pour vous aider et répondre à toutes vos interrogations.
        </p>
      </div>
        ...
        <div className="animate-on-scroll opacity-0 transition-all duration-700 delay-200">
          <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10">
            ...
            <form className="space-y-6">
              ...
              <button 
                type="submit" 
                className="w-full px-6 py-3 bg-sky-500 hover:bg-sky-600 text-white font-medium rounded-lg transition-all duration-300"
              >
                Envoyer le message
              </button>
            </form>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-sky-500/20 flex items-center justify-center mr-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">contact@carrotsante.fr</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">123 Avenue de la Santé, 75001 Paris</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-sky-500 transition-all duration-300">
      ...
      <div className="mt-16 pt-8 border-t border-white/10 text-center animate-on-scroll opacity-0 transition-all duration-700 delay-400">
        <p className="text-slate-400">© 2023 Carrot Santé. Tous droits réservés.</p>
      </div>
    </div>
  )
} 