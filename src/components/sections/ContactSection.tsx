...
export const ContactSection = () => {
  ...
  return (
    <div ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 flex flex-col min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center flex-grow">
        <div className="animate-on-scroll opacity-0 transition-all duration-700 delay-100">
          ...
          <div className="mt-8 flex space-x-4">
            <a href="#" className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-sky-500/20 text-sky-400 hover:bg-sky-500 hover:text-white transition-colors">
        ...
        <div className="p-6 rounded-xl shadow-sm bg-white border border-slate-100 animate-on-scroll opacity-0 transition-all duration-700 delay-300">
